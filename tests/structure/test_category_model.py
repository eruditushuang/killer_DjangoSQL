...
import sqlmovies.models.category


class StructureTestSuite(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.MODULE = sqlmovies.models.category

    def test_class_exists_category(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"Q2F0ZWdvcnk=").decode(),
            classes,
            msg=f"The class "
            f"`{base64.b64decode(b'Q2F0ZWdvcnk=').decode()}` "
