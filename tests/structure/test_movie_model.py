...
import sqlmovies.models.movie


class StructureTestSuite(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.MODULE = sqlmovies.models.movie

    def test_class_exists_movie(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"TW92aWU=").decode(),
            classes,
            msg=f"The class "
            f"`{base64.b64decode(b'TW92aWU=').decode()}` "
