...
import sqlmovies.models.actor


class StructureTestSuite(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.MODULE = sqlmovies.models.actor
    
    def test_class_exists_actor(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b'QWN0b3I=').decode(),
            classes,
            msg=f"The class "
                f"`{base64.b64decode(b'QWN0b3I=').decode()}` "
